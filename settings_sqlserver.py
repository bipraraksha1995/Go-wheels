...
MIDDLEWARE = [
    ...
    'gowheels.security_headers.SecurityHeadersMiddleware',
    'gowheels.rate_limiting.RateLimitMiddleware',
]
...
DATABASES = {
    'default': {
        'ENGINE': 'mssql',
        'NAME': config('DB_NAME', default='gowheels_db'),
